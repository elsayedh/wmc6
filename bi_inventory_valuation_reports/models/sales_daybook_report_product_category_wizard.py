...
# class PProductInherit(models.Model):
...
class sale_day_book_wizard(models.TransientModel):
    ...
    def get_lines(self, data):
        ...
        for product in  product_res:
            ...
            if ending_bal > 0:
                percentage = sales_value / ending_bal
            else:
                percentage = 0
            vals = {
    ...
    def get_data(self,data):
        ...
        for product in  product_res:
            ...
            if ending_bal != 0:
                percentage = round(sales_value / ending_bal,2)
            else:
                percentage = 0
            ...
            for i in lines:
                if i['category'] == product.categ_id.name:
                    ...
                    i['percentage'] = i['percentage'] + percentage
    ...
    def print_exl_report(self):
        ...
        if self.display_sum:
            ...
            worksheet.write(8, 7, 'Percent', style_table_header)
            ...
            for each in get_line:
                ...
                worksheet.write(prod_row, prod_col+7, each['percentage'], style)
            ...
            worksheet.write(8, 11, 'Percent', style_table_header)
            ...
            for each in get_line:
                ...
                worksheet.write(prod_row, prod_col+11, each['percentage'], style)
